...
| --- | --- | --- |
| Understand something as a picture | `/eli5 <topic>` — typed explicitly | `eli5` — HTML artifact by default; SVG or PNG when the diagram has to live in a doc or a message |
